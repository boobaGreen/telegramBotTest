...
const isBotAdmin = (ctx) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
      const administrators = yield ctx.telegram.getChatAdministrators(
        (_b =
          (_a = ctx.message) === null || _a === void 0 ? void 0 : _a.chat) ===
          null || _b === void 0
          ? void 0
          : _b.id
      );
...
const isUserAdmin = (ctx, userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
    try {
      const administrators = yield ctx.telegram.getChatAdministrators(
        (_d =
          (_c = ctx.message) === null || _c === void 0 ? void 0 : _c.chat) ===
          null || _d === void 0
          ? void 0
          : _d.id
      );
...
bot.command("stats", (ctx) => {
  var _a, _b;
  const chatId =
    (_b = (_a = ctx.message) === null || _a === void 0 ? void 0 : _a.chat) ===
      null || _b === void 0
      ? void 0
      : _b.id;
...
bot.command("set_limit", (ctx) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _e, _f, _g, _h, _j;
    const chatId =
      (_f = (_e = ctx.message) === null || _e === void 0 ? void 0 : _e.chat) ===
        null || _f === void 0
        ? void 0
        : _f.id;
    const userId =
      (_h = (_g = ctx.message) === null || _g === void 0 ? void 0 : _g.from) ===
        null || _h === void 0
        ? void 0
        : _h.id;
    if (chatId && userId) {
...
bot.command("remove_limit", (ctx) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _k, _l, _m, _o;
    const chatId =
      (_l = (_k = ctx.message) === null || _k === void 0 ? void 0 : _k.chat) ===
        null || _l === void 0
        ? void 0
        : _l.id;
    const userId =
      (_o = (_m = ctx.message) === null || _m === void 0 ? void 0 : _m.from) ===
        null || _o === void 0
        ? void 0
        : _o.id;
    if (chatId && userId) {
...
bot.on("message", (ctx, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _p, _q, _r, _s;
    const chatId =
      (_q = (_p = ctx.message) === null || _p === void 0 ? void 0 : _p.chat) ===
        null || _q === void 0
        ? void 0
        : _q.id;
    const chatType =
      (_s = (_r = ctx.message) === null || _r === void 0 ? void 0 : _r.chat) ===
        null || _s === void 0
        ? void 0
        : _s.type;
    ...
    if (isAdmin && groupStats[chatId]) {
      ...
      console.log(
        `Il bot con ID ${bot.botInfo.id} non è più un amministratore.`
      );
    }
    next();
  })
...
const sendEmptyReport = (chatId, chatInfo) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!chatId) {
...
const sendReport = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    for (const [chatId, stats] of Object.entries(groupStats)) {
      ...
      const participantsCount = yield (0,
      getMemberCount_1.getParticipantsCount)(chatId);
      ...
      try {
        ...
        const response = yield axios.post(
          finalEndPoint,
          payload, // Specifica il tipo di payload come ReportPayload ,
          {
            headers: {
              "Content-Type": "application/json",
